jQuery(document).ready(function ($) {
    ...
    const i18n           = SanadTrackerMaterialPricesAjax.i18n;
    let materials        = [];
    ...
    function loadMaterials(regionId) {
        ...
        $.get(SanadTrackerMaterialPricesAjax.ajax_url, {
            action: 'sanad_tracker_get_materials',
            nonce:  SanadTrackerMaterialPricesAjax.materials_nonce,
            region_id: regionId
    ...
    function loadAdminList(regionId) {
        ...
        $.get(SanadTrackerMaterialPricesAjax.ajax_url, {
            ...
            nonce: SanadTrackerMaterialPricesAjax.nonce,
            region_id: regionId
        }).done(function (response) {
    ...
    form.on('submit', function (e) {
        ...
        $.post(SanadTrackerMaterialPricesAjax.ajax_url, {
