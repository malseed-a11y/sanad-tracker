jQuery(document).ready(function ($) {
    ...
    const i18n         = SanadTrackerLandPricesAjax.i18n;
    ...
    function loadAdminList(regionId) {
        ...
        $.get(SanadTrackerLandPricesAjax.ajax_url, {
            action: 'sanad_tracker_get_land_prices_admin_list',
            nonce: SanadTrackerLandPricesAjax.nonce,
            region_id: regionId
        }, function (response) {
    ...
    form.on('submit', function (e) {
        ...
        $.post(SanadTrackerLandPricesAjax.ajax_url, {
