document.addEventListener('DOMContentLoaded', function () {
    ...
    wrappers.forEach(function (wrapper) {
        ...
        const i18n = SanadTrackerMaterials.i18n;
        ...
        async function fetchRegionsList() {
            ...
            formData.append('nonce', SanadTrackerMaterials.nonce);

            try {
                const response = await fetch(SanadTrackerMaterials.ajax_url, { method: 'POST', body: formData });
