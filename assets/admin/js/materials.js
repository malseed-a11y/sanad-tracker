jQuery(document).ready(function ($) {
    ...
    addForm.on('submit', function (e) {
        ...
        $.post(SanadTrackerMaterials.ajax_url, {
            action: 'sanad_tracker_add_material',
            nonce: SanadTrackerMaterials.nonce,
            name: name
        }, function (response) {
            if (response.success) {
                Swal.fire({
                    icon: 'success',
                    title: SanadTrackerMaterials.i18n.added,
                ...
                Swal.fire({
                    icon: 'error',
                    title: SanadTrackerMaterials.i18n.error,
                    text: response.data.message
                });
            }
        });
    ...
    editForm.on('submit', function (e) {
        ...
        $.post(SanadTrackerMaterials.ajax_url, {
            ...
            if (response.success) {
                Swal.fire({
                    icon: 'success',
                    title: SanadTrackerMaterials.i18n.updated,
                    text: response.data.message,
                    timer: 2000,
                    showConfirmButton: false
                }).then(function () {
    ...
    $(document).on('click', '.delete-material-btn', function (e) {
        ...
        Swal.fire({
            title: SanadTrackerMaterials.i18n.confirm_delete_title,
            text: SanadTrackerMaterials.i18n.confirm_delete_text,
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#d33',
            cancelButtonColor: '#3085d6',
            confirmButtonText: SanadTrackerMaterials.i18n.confirm_delete_yes,
            cancelButtonText: SanadTrackerMaterials.i18n.cancel
            ...
            if (result.isConfirmed) {
                $.post(SanadTrackerMaterials.ajax_url, {
                    ...
                    if (response.success) {
                        Swal.fire({
                            icon: 'success',
                            title: SanadTrackerMaterials.i18n.deleted,
                            text: response.data.message,
                            timer: 2000,
                            showConfirmButton: false
                        }).then(function () {
